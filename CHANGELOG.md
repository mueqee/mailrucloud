...
## [1.4.2] - 2025-07-20
- Реализована многопоточная загрузка файлов (параметр --threads, по умолчанию 4)
...
- Улучшена производительность синхронизации в 4-8 раз
- Реализован улучшенный прогресс-бар с процентом выполнения, счётчиком файлов, оставшимся временем и скоростью загрузки
- Добавлена визуальная индикация успешно загруженных файлов
- Исправлены ошибки в CLI интерфейсе
- Протестировано на реальных данных

## [1.4.3] - 2025-07-28
- Исправлены ошибки прогресс-бара с кастомными полями
- Заменены кастомные поля на стандартные компоненты Rich
- Улучшена стабильность многопоточной загрузки
- Добавлена обработка случая "нет файлов для загрузки"
- Протестировано на папке с кириллическими именами файлов
